...
import searchRabinKarp from '../rabin-karp/rk.js';
...
describe('Rabin-Karp', () => {
  describe('`searchRabinKarp` method', () => {
    ...
    it('str.length < text.length and several matches', () => {
      expect(searchRabinKarp('abcdefabcdefabcdef', 'cd')).to.deep.equal([
        2, 8, 14,
      ]);
    });
    it('str.length == text.length and match', () => {
    ...
    it('long string', () => {
      expect(
        searchRabinKarp(
          'abcdabcabcabcabcabcabcabcabcabcabcabcabcabcabcabcabcabcabcabcabcabcabcabc',
          'cd'
        )
      ).to.deep.equal([2]);
    });
